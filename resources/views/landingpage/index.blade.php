...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-12 col-xxl-5">
                        ...
                        <div class="text-center">
                            <div class="fs-4 fw-light text-muted mb-3">
                                I can help your business From Development to Quality – Ensuring the Best Digital Experience
                            </div>
                            <h1 class="display-4 fw-bolder mb-3">
                                <span class="text-gradient d-inline">Naoval Fadilah</span>
                            </h1>
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-3">
                                <div class="text-uppercase">QUALITY ASSURANCE &middot; UI/UX &middot; WEB DEVELOPER</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="profile bg-gradient-primary-to-secondary">
                                <!-- Gunakan foto dengan background transparan untuk hasil terbaik-->
                                <img class="profile-img" src="assets/profile-removebg-preview.png" alt="Profile Picture"/>
                                <!-- SVG dots tetap dipertahankan -->
                                <div class="dots-1">
                                    <!-- SVG Dots-->
        ...
        <div class="d-grid gap-3 d-flex justify-content-center mb-3">
            <a class="btn btn-primary btn-lg px-5 py-3 me-3 fs-6 fw-bolder" href="{{ route('resume') }}">Resume</a>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <br>
                            <p class="text-muted">Naoval Fadilah has experience as a Quality Assurance (QA)
                                professional, with expertise in manual testing, creating test cases, test scenarios, and
                                test reports. He is experienced in using JIRA and GitHub for onboarding projects,
                                managing to-do lists, and collaborating with teams. As a Full Stack Developer, Naoval is
                                skilled in developing web applications using Laravel, MySQL, PHP, HTML, and CSS. He also
                                has experience in UI design using Figma and is continuously learning to enhance his
                                skills in Automation Testing.</p>
                            <br>
                            <p class="text-muted">Naoval's portfolio includes a variety of projects showcasing his
                                capabilities in QA and software development. Key projects include testing applications
                                such as ITDP LP360 Bank BJB and Pakarangan Glamping Resort, as well as developing web
                                applications using Laravel and MySQL. Additionally, Naoval has experience in UI design
                                using Figma for UX projects and managing system workflows and application test
                                documentation.</p>
                            <br>
                            <p class="text-muted">Naoval has a strong interest in the IT sector, particularly in Quality
                                Assurance and software development. He is eager to further develop his skills in
                                Automation Testing and deepen his technical knowledge in application development.
                                Additionally, Naoval focuses on strengthening his technical and managerial skills in the
                                IT industry to contribute to the success of the projects he works on.</p>
